...
public class TextIndex {
    ...
    public void TextIndex(String str) {
        ...
        String htmlHead = "<html> <body LANG=\"ar-SA\" DIR=\"LTR\"> <center><font size=3> <b>«·›ÛÂ—Û”Û… <br> Indexing</b></font></center><br>\n";
        htmlHead += "";
        ...
        htmlHead += "<P align=\"right\"> ⁄œœ «·ﬂ·„«  €Ì— «·„ﬂ——…:";
        ...
        htmlHead += cellBeg + "<B>«·”Ì«ﬁ« </B>" + cellEnd + cellBeg + "<B> „Ê«ﬁ⁄ «·ﬂ·„«  </B>" + cellEnd + cellBeg + "<B>«· ﬂ—«—</B>" + cellEnd + cellBeg + "<B>«·ﬂ·„…</B>" + cellEnd + "</TR>";
