...
//creat the menu file and his options open, save, save as and close
    ...
    public static void fileWrite2(File fichier) {
        ...
        try {
            ...
            str.append("<center><font size=7><b><br>‰ «∆Ã «· Õ·Ì·<br>Analysis Results</b></font></center><br>\n");
            str.append("<TABLE WIDTH=100% BORDER=1>\n");

            str.append("<TR>\n");
            str.append("<TD COLSPAN=8 BGCOLOR=\"#DBDBFF\"  VALIGN=TOP>\n");
            str.append("<P DIR=\"RTL\" ALIGN=CENTER><font size=7>«·Œ—Ã</font><br><font size=5>OUTPUT</font></P>\n");
            str.append("</TD>\n");
            str.append("<TD  ROWSPAN=2 BGCOLOR=\"#E2C9A6\">\n");
            str.append("<P DIR=\"RTL\" ALIGN=CENTER><font size=7>«·œŒ·</font><br><font size=5>INPUT</font></P>\n");
            str.append("</TD>\n");
            str.append("</TR>\n");
            str.append("<TR >\n");
            str.append("<TD  BGCOLOR=\"#DBDB70\" VALIGN=TOP>\n");
            str.append("<P DIR=\"RTL\" ALIGN=CENTER><font size=5>«··«Õﬁ</font><br><font size=5>Suffix</font></P>\n");
            str.append("</TD>\n");

            str.append("<TD  VALIGN=TOP BGCOLOR=\"#DBDB70\">\n");
            str.append("<P DIR=\"RTL\" ALIGN=CENTER><font size=5>«·Õ«·… «·≈⁄—«»Ì…</font><br><font size=5>POS Tags</font>\n");
            str.append("</P>\n");
            str.append("</TD>\n");
            str.append("<TD  VALIGN=TOP BGCOLOR=\"#DBDB70\">\n");
            str.append("<P DIR=\"RTL\" ALIGN=CENTER><font size=5>«·Ã–—</font><br><font size=5>Root</font>\n");
            str.append("</P>\n");
            str.append("</TD>\n");
            str.append("<TD  VALIGN=TOP BGCOLOR=\"#DBDB70\">\n");
            str.append("<P DIR=\"RTL\" WIDTH=15% ALIGN=CENTER><font size=5>«·Ê“‰</font><br><font size=5>Pattern</font>\n");
            str.append("</P>\n");
            str.append("</TD>\n");
            str.append("<TD  VALIGN=TOP BGCOLOR=\"#DBDB70\">\n");
            str.append("<P DIR=\"RTL\" ALIGN=CENTER><font size=5>‰Ê⁄ «·ﬂ·„…</font><br><font size=5>Type</font>\n");
            str.append("</P>\n");
            str.append("</TD>\n");
            str.append("<TD  VALIGN=TOP BGCOLOR=\"#DBDB70\">\n");
            str.append("<P DIR=\"RTL\" ALIGN=CENTER><font size=5>«·Ã–⁄</font><br><font size=5>Stem</font></P>\n");
            str.append("</TD>\n");
            str.append("<TD  VALIGN=TOP BGCOLOR=\"#DBDB70\">\n");
            str.append("<P DIR=\"RTL\" ALIGN=CENTER><font size=5>«·”«»ﬁ</font><br><font size=5>Prefix</font></P>\n");
            str.append("</TD>\n");
            str.append("<TD  VALIGN=TOP BGCOLOR=\"#DBDB70\">\n");
            str.append("<P DIR=\"RTL\" ALIGN=CENTER><font size=5>«·ﬂ·„… «·„‘ﬂÊ·…</font><br><font size=5>Voweled Word</font></P>\n");
            str.append("</TD>\n");
            str.append("</TR>\n");
            ...
            while (it.hasNext()) {
                ...
                while (itn.hasNext()) {
                    ...
                    if (result.isEmpty()) {
                        ...
                        str.append("<P ALIGN=CENTER><font size=5><b>" + "·«  ÊÃœ ‰ «∆Ã · Õ·Ì· Â–Â «·ﬂ·„…" + "</b></font></P>\n");
                        str.append("</TD>\n");
