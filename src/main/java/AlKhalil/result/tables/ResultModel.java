...
public class ResultModel extends AbstractTableModel {
    ...
    public void initVectors() {
        ...
        columnNames.addElement("«Œ Ì«—");
        columnNames.addElement("«·œŒ·");

        columnNames.addElement("«·ﬂ·„… «·„‘ﬂÊ·…");
        columnNames.addElement("«·”«»ﬁ");
        columnNames.addElement("«·Ã–⁄");
        columnNames.addElement("‰Ê⁄ «·ﬂ·„…");
        columnNames.addElement("Ê“‰ «·ﬂ·„…");
        columnNames.addElement("Ã–— «·ﬂ·„…");
        columnNames.addElement("«·Õ«·… «·≈⁄—«»Ì…");
        columnNames.addElement("«··«Õﬁ");
